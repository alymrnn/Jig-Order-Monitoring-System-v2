<div class="modal fade" id="full_rfq" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-footer">
        ...
        <input type="submit" class="btn btn-primary" name="upload" value="Upload" id ="full_rfq_btn" onclick = "import_full_rfq_button()">
      </div>
         </form>
    </div>
  </div>
