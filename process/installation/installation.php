...
if ($method == 'fetch_request') {
	...
	$c = 0;
	$query = "SELECT joms_request.id,joms_request.request_id,joms_request.status, joms_request.carmaker, joms_request.carmodel, joms_request.product, joms_request.jigname, joms_request.drawing_no, joms_request.type, joms_request.qty, joms_request.purpose, joms_request.budget, joms_request.shipping_method,
	...
	joms_rfq_process.target_approval_date_of_quotation, joms_po_process.approval_date_of_quotation, joms_po_process.target_date_submission_to_purchasing, joms_po_process.actual_date_of_submission_to_purchasing, joms_po_process.target_po_date, joms_po_process.date_received_po_doc_purchasing, joms_po_process.date_issued_to_requestor, joms_po_process.issued_to,joms_po_process.po_date, joms_po_process.po_no,  joms_po_process.supplier, joms_po_process.etd, joms_po_process.eta, joms_po_process.actual_arrival_date, joms_po_process.invoice_no, joms_po_process.po_uploaded_by , joms_po_process.remarks AS remarks2,
	...
	if ($stmt->rowCount() > 0) {
		foreach ($stmt->fetchALL() as $j) {
			...
			echo '<td style = "' . $color2 . '">' . $j['validity_quotation'] . '</td>';
			...
			echo '<td style = "' . $color2. '">' . $j['rfq_status'] . '</td>';
			...
			echo '<td style = "' . $color3 . '">' . $j['date_received_po_doc_purchasing'] . '</td>';
			echo '<td style = "' . $color3 . '">' . $j['date_issued_to_requestor'] . '</td>';
			echo '<td style = "' . $color3 . '">' . $j['issued_to'] . '</td>';
