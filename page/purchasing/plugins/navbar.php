    ...
    <nav class="main-header navbar navbar-expand navbar-white navbar-light">
      ...
      <ul class="navbar-nav ml-auto">
        <li class="nav-item dropdown">
          <a class="nav-link" data-toggle="dropdown" href="#" id="notif_badge" aria-expanded="false"><i
              class="far fa-bell"></i></a>
          <div class="dropdown-menu dropdown-menu-lg dropdown-menu-right" style="left: inherit; right: 0px;">
            <span class="dropdown-header" id="notif_title">Notifications</span>
            <div class="dropdown-divider"></div>
            <a href="dashboard.php" class="dropdown-item" id="notif_new_joms_request"><i
                class="fas fa-exclamation-circle mr-2"></i> no new request <span
                class="float-right text-muted text-sm"></span></a>
          </div>
        </li>
        <li class="nav-item">
